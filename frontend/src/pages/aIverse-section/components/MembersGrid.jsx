...
const MembersGrid = () => {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      avatar: "/images/team/placeholder-avatar.svg",
      bio: "Supporting club operations and ensuring smooth execution of all AIverse initiatives and programs.",
      expertise: ["Administration", "Event Planning", "Team Coordination"],
      achievements: ["Operations Excellence", "Team Support", "Program Management"],
